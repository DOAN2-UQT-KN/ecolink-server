...
set -e
for name in durable-background-job notification-send green-point facebook-recognition ai-analysis-job report-analysis-job incident-translation reward-translation notification-translation; do
